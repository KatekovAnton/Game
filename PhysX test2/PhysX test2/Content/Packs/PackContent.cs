...
namespace PhysX_test2.Content
{
    ...
    {
        public int _userCount;
        public PackEngineObject _engineSampleObject;
        public PackContentEntity ReadedContentObject;
    ...
    public abstract class PackContentEntity
    {
        public abstract void LoadBody(byte[] __data);
    }

    public class PackEngineObject
    { }
}
